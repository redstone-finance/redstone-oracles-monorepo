...
(by end users).
Until that moment data remains in the decentralised cache layer, which is powered by RedStone light cache gateways. Data is transferred to the contract by end users, who should attach signed data
