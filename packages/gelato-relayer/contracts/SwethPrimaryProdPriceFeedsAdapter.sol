...
import "@redstone-finance/on-chain-relayer/contracts/price-feeds/without-rounds/PriceFeedsAdapterWithoutRounds.sol";

contract SwethPrimaryProdPriceFeedsAdapter is PriceFeedsAdapterWithoutRounds {
  function getDataFeedIds() public pure override returns (bytes32[] memory dataFeedIds) {
    dataFeedIds = new bytes32[](1);
    dataFeedIds[0] = bytes32("SWETH");
  }
