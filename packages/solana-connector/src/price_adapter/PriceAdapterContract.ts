...
import * as idl from "../_autogenerated/redstone_solana_price_adapter.json";
...
export class PriceAdapterContract {
  ...
  static createMultiContract(
    ...
    return MultiExecutor.createForSubInstances(
      ...
      (conn) => new PriceAdapterContract(conn, address, accountForSimulations),
      {
        ...
        getMultiplePriceData: MultiExecutor.ExecutionMode.AGREEMENT,
      },
      {
  ...
  constructor(
    ...
    this.client = new SolanaClient(connection);
