...
/* tslint:disable */
/* eslint-disable */
export type ParticipantAuthorizationOnboarding1 = {
    /**
     * Required
     */
    partyId: string;
     ...
     * Required
     */
    participantPermission: ParticipantAuthorizationOnboarding1.participantPermission;
};
export namespace ParticipantAuthorizationOnboarding1 {
    /**
     * Required
     */
