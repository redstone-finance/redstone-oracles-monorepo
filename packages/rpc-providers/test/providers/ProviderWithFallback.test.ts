...
describe("ProviderWithFallback", () => {
  ...
  describe("with first always failing and second always working provider", () => {
    ...
    beforeEach(() => {
      const alwaysFailingProvider = new providers.JsonRpcProvider("http://blabla.xd");
      fallbackProvider = new ProviderWithFallback([alwaysFailingProvider, hardhat.ethers.provider]);
