...
module price_feed_usdc::price_feed_usdc;
...
/// Usdc feed id
const FEED_ID: vector<u8> = x"5553444300000000000000000000000000000000000000000000000000000000";
const DESCRIPTION: vector<u8> = b"RedStone Price Feed for USDC";
