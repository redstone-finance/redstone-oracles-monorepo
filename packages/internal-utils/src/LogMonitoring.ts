...
export enum LogMonitoringType {
  ...
  HIP3_UPPER_BOUND_CROSSED = "HIP3_UPPER_BOUND_CROSSED",
  HIP3_LOWER_BOUND_CROSSED = "HIP3_LOWER_BOUND_CROSSED",
  ...
  MERGER_UNAUTHORIZED_KEY_REJECTED = "MERGER_UNAUTHORIZED_KEY_REJECTED",
  MERGER_UPGRADE_RATE_LIMIT_EXCEEDED = "MERGER_UPGRADE_RATE_LIMIT_EXCEEDED",
  MERGER_CONNECTION_LIMIT_EXCEEDED = "MERGER_CONNECTION_LIMIT_EXCEEDED",
  MERGER_MESSAGE_RATE_LIMIT_EXCEEDED = "MERGER_MESSAGE_RATE_LIMIT_EXCEEDED",
  MERGER_BACKPRESSURE_LIMIT_EXCEEDED = "MERGER_BACKPRESSURE_LIMIT_EXCEEDED",
  MERGER_TOPIC_LIMIT_EXCEEDED = "MERGER_TOPIC_LIMIT_EXCEEDED",
  // Relayer
