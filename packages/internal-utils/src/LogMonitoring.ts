...
export enum LogMonitoringType {
  USING_EXPIRED_CACHED_MANIFESTS = "USING_EXPIRED_CACHED_MANIFESTS",
  NODE_S3_DATA_SAVE_FAILED = "NODE_S3_DATA_SAVE_FAILED",
  ...
  PUB_SUB_FALLBACK_USED_BUT_USEFUL = "PUB_SUB_FALLBACK_USED_BUT_USEFUL",
  PUB_SUB_FALLBACK_USED_AND_FAILED = "PUB_SUB_FALLBACK_USED_AND_FAILED",
  PUB_SUB_TOPIC_RATE_LIMITED = "PUB_SUB_TOPIC_RATE_LIMITED",
  PUB_SUB_CLIENT_RATE_LIMITED = "PUB_SUB_CLIENT_RATE_LIMITED",
  UNEXPECTED_ERROR = "UNEXPECTED_ERROR",
  PRIMARY_SOURCE_AGGREGATOR_FALLBACK_ACTIVATED = "PRIMARY_SOURCE_AGGREGATOR_FALLBACK_ACTIVATED",
  BTCB_VIOLATES_LOWER_CAP_LIMIT = "BTCB_VIOLATES_LOWER_CAP_LIMIT",
  // Extended TradFi RFQ: no fresh Hyperliquid data and no usable fallback (off-hours or missing),
  // so the feed keeps delivering its last cached value.
  TRADFI_RFQ_STALE_FALLBACK = "TRADFI_RFQ_STALE_FALLBACK",
  // HIP3
  ...
  HIP3_FALLBACK_TO_EMA = "HIP3_FALLBACK_TO_EMA",
  ...
  FUTURES_CALENDAR_NEAR_EMPTY = "FUTURES_CALENDAR_NEAR_EMPTY",
